...
public class HUDEdit extends HUDElement {
	...
	public HUDEdit(int x, int y, int width, int height, Keys keys, HUD owner) {
	...
	@Override
	public void tick() {
		MouseButtons mb = getOwner().getOwner().getOwner().getMouseButtons();
		if (mb.isPressed()) {
