...
public class GUIDynamicButton extends GUIElement{
	...
	public GUIDynamicButton(int x, int y, Bitmap[] i, String s, int id, GUIMenu owner) {
	...
	protected void repaint() {
		...
		for (int i = 0; i < 4; i++) {
			...
			if (standardY >= 0) {
				...
				y = getHeight()/2 - font.getSize()/2 - 4;
			}
