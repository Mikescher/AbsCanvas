...
public class GUIAnimatedButton extends GUIElement{
	...
	public GUIAnimatedButton(int x, int y, int width, int height, Bitmap[][] i, int speed, int id, GUIMenu owner) {
	...
	public GUIAnimatedButton(int x, int y, Bitmap[][] i, int speed, int id, GUIMenu owner) {
